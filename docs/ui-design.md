...
| `/gallery` | GalleryPage | User gallery view |
...
| `/admin/gallery` | GalleryPage | Admin gallery view |
...
<p style="text-align: center;">User UI Header</p>

![UI Header Admin](images/ui_header_admin.png)
<p style="text-align: center;">Admin UI Header</p>
