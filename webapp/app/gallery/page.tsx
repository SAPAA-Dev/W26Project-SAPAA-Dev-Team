...
import { Loader2, MapPin, FileText, ImageIcon, X, Maximize2, Search, ArrowLeft, Calendar, User } from "lucide-react";
  ...
  useEffect(() => {
    const fetchGallery = async () => {
      try {
        ...
        const res1 = await fetch("/api/user-gallery/homepage-upload");
